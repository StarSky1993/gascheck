<template>
    <view class="maintain">
		...
		<view class="content">{{showData.aj_wz}}</view>
		...
		<view class="upload">
			<view>
				...
				<view class="uploadImg"><lazy-image :realSrc="'http://bdh-ranqi.qhd58.net' + showData.wei_yuan" :placeholdSrc="placeholderSrc"></lazy-image></view>
			</view>
			<view>
				<text class="center">近景</text>
				<view class="uploadImg"><lazy-image :realSrc="'http://bdh-ranqi.qhd58.net' + showData.wei_jin" :placeholdSrc="placeholderSrc"></lazy-image></view>
			</view>			
			<view>
				<text class="center">特写</text>
				<view class="uploadImg"><lazy-image :realSrc="'http://bdh-ranqi.qhd58.net' + showData.wei_te" :placeholdSrc="placeholderSrc"></lazy-image></view>
			</view>		
		</view>	
		<view class="content5">
			<text class="text6">详细描述：</text>
			<view class="textarea">{{showData.wx_wz}}</view>		
		</view>	
	</view>
</template>
