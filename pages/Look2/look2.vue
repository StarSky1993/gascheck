    ...
    <view class="maintain">
		...
		<view class="upload">
			<view>
				...
				<view class="uploadImg"><lazy-image :realSrc="'http://ranqi.qhd58.net' + showData.wei_yuan" :placeholdSrc="placeholderSrc"></lazy-image></view>
			</view>
			<view>
				<text class="center">近景</text>
				<view class="uploadImg"><lazy-image :realSrc="'http://ranqi.qhd58.net' + showData.wei_jin" :placeholdSrc="placeholderSrc"></lazy-image></view>
			</view>			
			<view>
				<text class="center">特写</text>
				<view class="uploadImg"><lazy-image :realSrc="'http://ranqi.qhd58.net' + showData.wei_te" :placeholdSrc="placeholderSrc"></lazy-image></view>
			</view>		
		</view>	
		<view class="content5">
